...
public class Funcionario {
	...
	public String toString() {
		return "Funcionario [id=" + id + ", nome=" + nome + ", cargo=" + cargo + ", telefone=" + telefone + ", celular="
				+ celular + ", email=" + email + ", cpf=" + cpf + ", rg=" + rg + ", orgao_emissor=" + orgao_emissor
				+ ", cep=" + cep + ", estado=" + estado + ", cidade=" + cidade + ", bairro=" + bairro + ", rua=" + rua
				+ ", numero=" + numero + ", complemento=" + complemento + ", login=" + login + ", senha=" + senha + "]";
	}
